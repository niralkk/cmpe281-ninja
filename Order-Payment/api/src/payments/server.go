...
func (mw *MongoWriter) Write(p []byte) (n int, err error) {
    ...
    url:="http://cmpe281-loadbalancer-1689084271.us-west-1.elb.amazonaws.com:7001/getEmail"
    ...
    fmt.Println("Amount written is: ",amount)
...
func initRoutes(mx *mux.Router, formatter *render.Render) {
	...
	mx.HandleFunc("/", ping(formatter)).Methods("GET")
}
