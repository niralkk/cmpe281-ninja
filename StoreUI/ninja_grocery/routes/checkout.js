...
var server_ip_sc = const_file.server_ip_sc;
var server_port_sc = const_file.server_port_sc;
/* GET users listing. */
router.get('/',isLoggedIn, function(req, res, next) {
    ...
    var options = {
                  // Add AWS URI
                  uri: 'http://'+server_ip_sc+':'+server_port_sc+'/getusercart',
                  method: 'POST',
                        ...
                        if (!error && response.statusCode == 200) {
                          ...
                          //console.log(body['usercart']);
                           ...
                           var options = {
                            ...
                            var options = {
                                      // Add AWS URI
                                      uri: 'http://'+server_ip_sc+':'+server_port_sc+'/removeusercart',
                                      method: 'POST',
